...
<style>
  body{font-family:Arial,sans-serif;font-size:10.5pt;color:#111111;margin:1cm 1.2cm;line-height:1.3}
  h1{font-size:16pt;border-bottom:3px solid #ea5403;padding-bottom:3px;margin-bottom:4px}
  h2{font-size:11pt;color:#ea5403;margin-top:5px;margin-bottom:1px;border-bottom:1px solid #e0e0e0;padding-bottom:1px}
  h3{font-size:10pt;color:#555555;margin-top:3px;margin-bottom:1px}
  p{margin:1px 0}
  table{border-collapse:collapse;width:100%;font-size:9.5pt;margin-top:2px}
  th{background:#ea5403;color:#fff;padding:3px 6px;text-align:left}
  td{padding:3px 6px;border:1px solid #e0e0e0}
  tr:nth-child(even) td{background:#f2f2f2}
  .nt td{border:none!important;background:transparent!important;color:#555}
  .meta{color:#666;font-size:9pt;margin:2px 0}
  .footer{margin-top:12px;border-top:1px solid #e0e0e0;padding-top:4px;font-size:8.5pt;color:#888}
  @media print {
    body{margin:1cm 1.2cm}
    .no-print{display:none!important}
  }
</style>
</head><body>
<p class="no-print" style="text-align:right;margin-bottom:8px">
  <button onclick="window.print()" style="padding:6px 16px;font-size:10pt;background:#ea5403;color:#fff;border:none;cursor:pointer;border-radius:3px">🖨️ Afdrukken / Opslaan als PDF</button>
</p>
