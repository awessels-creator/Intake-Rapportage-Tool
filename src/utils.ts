...
export const QUICK_SECTIONS: QuickSection[] = [
  {
    ...
    groups: [
      ...
      { label: 'Sociale situatie', type: 'check', items: [
        ...
        { id: 'a_soc_mantelzorg', label: 'Mantelzorger', s: 'Inwoner is mantelzorger.' },
        ...
        { id: 'a_soc_geen_familie', label: 'Geen familie', s: 'Inwoner heeft geen familie.' },
        { id: 'a_soc_vrienden', label: 'Vrienden/kenniskring', s: 'Inwoner heeft een vrienden/kennissenkring.' },
        { id: 'a_soc_sport', label: 'Sport/hobby/vereniging', s: 'Inwoner heeft sociale of buitenshuis activiteiten (sport, hobby, vereniging).' },
      ] },
      { label: 'Gezondheid', type: 'check', items: [
        ...
        { id: 'a_gez_wmo', label: 'WMO-indicatie', s: 'Inwoner heeft een WMO-indicatie.' },
      ] },
  ...
  },
  {
    ...
    groups: [
      ...
      { label: 'Huidige arbeidssituatie', type: 'check', items: [
        { id: 'b_arbeid_werkzaam', label: 'Werkzaam', s: 'Inwoner is werkzaam.' },
        { id: 'b_arbeid_ww', label: 'WW', s: 'Inwoner ontvangt een WW-uitkering.' },
        { id: 'b_arbeid_wia', label: 'WIA/WAO', s: 'Inwoner ontvangt een WIA- of WAO-uitkering.' },
        { id: 'b_arbeid_zw', label: 'Ziektewet', s: 'Inwoner ontvangt een Ziektewet-uitkering.' },
        { id: 'b_arbeid_zzp', label: 'ZZP', s: "Inwoner is zzp'er." },
        { id: 'b_arbeid_geen', label: 'Niet werkzaam', s: 'Inwoner is niet werkzaam.' },
      ] },
  ...
  },
  {
    ...
    groups: [
      ...
      { label: 'Herkomst aanmelding', type: 'check', items: [
        { id: 'd_via_zelf', label: 'Zelf gemeld', s: 'Aanmelding: inwoner heeft zichzelf gemeld.' },
